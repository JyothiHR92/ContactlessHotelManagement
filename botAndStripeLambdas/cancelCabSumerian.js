...
function cancelCabBooking(intent, callback) {
  var phoneNumber;
  var messageText;
      ...
      .then(
          ...
          (content2) => {
            if (content2.statusCode == '200') {
              ...
              // var params = {
              //   Message: `Your request to cancel cab is successfully processed.`,
              //   PhoneNumber: "+1"+slots.PhoneNum,
              //   Subject: 'Cab cancel Confirmation'
              // };
              ...
              callback(close(intent.sessionAttributes, 'Fulfilled', {
                'contentType': 'PlainText',
                'content':
                     `Your request  to cancel cab is successfully processed.`}));
            }
          },
...
exports.handler = (event, context, callback) => {
  try {
    ...
    cancelCabBooking(event, (response) => {
